                                ...
                                <div class="row">
                                    <div class="col-xl-5 col-md-6 product-single-gallery">
                                        <div class="product-slider-container">
                                            <div class="product-single-carousel owl-carousel owl-theme show-nav-hover">
                                                <div class="product-item">
                                                    <img class="product-single-image" src="{{ asset('assets/images/zoom/2.png') }}" data-zoom-image="{{ asset('assets/images/zoom/2.png') }}" width="468" height="468" alt="product" />
                                        ...
                                        <div class="prod-thumbnail owl-dots">
                                            <div class="owl-dot">
                                                <img src="{{ asset('assets/images/zoom/2.png') }}" width="110" height="110" alt="product-thumbnail" /> 
                                            </div>
                                            <div class="owl-dot">
                                                <img src="{{ asset('assets/images/zoom/2.png') }}" width="110" height="110" alt="product-thumbnail" /> 
                                            </div>
                                    ...
                                    <div class="col-xl-7 col-md-6 product-single-details">
                                        ...
                                        <div class="price-box">
                                            <span class="product-price"> Tk35.00</span>
                                        </div>
                                        <!-- End .price-box -->
                                    ...
                                    <div class="product-default inner-quickview inner-icon">
                                        <figure>
                                            <a href="{{ url('/demo40-product') }}">
                                                <img src="{{ asset('assets/images/demoes/demo40/products/product-17.jpg') }}" width="205" height="205" alt="product">
