                ...
                <div class="col-6 col-sm-4">
                    <div class="product-default">
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Ultimate 3D Bluetooth
                                    Speaker</a> </h3>
                            ...
                            <div class="product-action">
                                ...
                                <a href="{{ url('/demo40-product') }}" class="btn-icon btn-add-cart"><i
                ...
                <div class="col-6 col-sm-4">
                    <div class="product-default">
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Brown Women Casual
                                    HandBag</a>
                            </h3>
                ...
                <div class="col-6 col-sm-4">
                    <div class="product-default">
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Circled Ultimate 3D
                                    Speaker</a> </h3>
                ...
                <div class="col-6 col-sm-4">
                    <div class="product-default">
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Blue Backpack for the Young
                                    -
                                    S</a> </h3>
                ...
                <div class="col-6 col-sm-4">
                    <div class="product-default">
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Casual Spring Blue
                                    Shoes</a>
                            </h3>
                ...
                <div class="col-6 col-sm-4">
                    <div class="product-default">
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Men Black Gentle Belt</a>
                            </h3>
                ...
                <div class="col-6 col-sm-4">
                    <div class="product-default">
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Brown-Black Men Casual
                                    Glasses</a> </h3>
                ...
                <div class="col-6 col-sm-4">
                    <div class="product-default">
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Black Men Casual
                                    Glasses</a>
                            </h3>
                ...
                <div class="col-6 col-sm-4">
                    <div class="product-default">
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Basketball Sports Blue
                                    Shoes</a> </h3>
                ...
                <div class="col-6 col-sm-4">
                    <div class="product-default">
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Men Sports Travel Bag</a>
                            </h3>
                ...
                <div class="col-6 col-sm-4">
                    <div class="product-default">
                        ...
                        <div class="product-details">
                            ...
                            <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Brown HandBag</a> </h3>
        ...
        <aside class="sidebar-shop col-lg-3 order-lg-first mobile-sidebar">
            <div class="sidebar-wrapper">
                        ...
                        <div class="owl-carousel widget-featured-products">
                            <div class="featured-col">
                                <div class="product-default left-details product-widget">
                                    ...
                                    <div class="product-details">
                                        <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Blue Backpack
                                                for
                                                the Young - S</a> </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                ...
                                <div class="product-default left-details product-widget">
                                    ...
                                    <div class="product-details">
                                        <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Casual Spring
                                                Blue
                                                Shoes</a> </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                ...
                                <div class="product-default left-details product-widget">
                                    ...
                                    <div class="product-details">
                                        <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Men Black
                                                Gentle
                                                Belt</a> </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                            ...
                            <div class="featured-col">
                                <div class="product-default left-details product-widget">
                                    ...
                                    <div class="product-details">
                                        <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Ultimate 3D
                                ...
                                <div class="product-default left-details product-widget">
                                    ...
                                    <div class="product-details">
                                        <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Brown Women
                                                Casual
                                                HandBag</a> </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                                ...
                                <div class="product-default left-details product-widget">
                                    ...
                                    <div class="product-details">
                                        <h3 class="product-title"> <a href="{{ url('/demo40-product') }}">Circled
                                                Ultimate
                                                3D Speaker</a> </h3>
                                        <div class="ratings-container">
                                            <div class="product-ratings">
                ...
                <div class="widget widget-block">
                    ...
                    <h5>WE CAN SHOW ADVERTISE HERE</h5>
