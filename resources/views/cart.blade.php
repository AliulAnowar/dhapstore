                                ...
                                <td colspan="2" class="text-left">
                                    ...
                                    <form action="#">
                                        <div class="form-group form-group-sm">
                                            <label>Shipping to <strong>Dhaka.</strong></label>
                                        ...
                                        <div class="form-group form-group-sm">
                                            <div class="select-custom">
                                                <select class="form-control form-control-sm">
                                                    <option value="NY">Dhaka</option>
                                                    <option value="CA">Rajshahi</option>
                                                    <option value="TX">Khulna</option>
                                                    <option value="NY">Chattogram</option>
                                                    <option value="CA">Rangpur</option>
                                                    <option value="TX">Sylhet</option>
                                                    <option value="TX">Barishal</option>
                                                </select>
                                            </div><!-- End .select-custom -->
                                        </div><!-- End .form-group -->
