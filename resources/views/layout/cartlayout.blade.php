...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Jan 2025 12:53:40 GMT -->
<!-- Added by HTTrack -->
            ...
            <div class="header-top">
                <div class="container">
                    <div class="header-left d-none d-sm-block">
                        <p class="top-message text-uppercase">FREE Returns. Standard Shipping Orders</p>
                    </div><!-- End .header-left -->
                    ...
                    <div class="header-right header-dropdowns ml-0 ml-sm-auto w-sm-100">
                        ...
                        <div class="header-dropdown">
                            ...
                            <div class="header-menu">
                                <ul>
                                    <li><a href="#"><i class="flag-us flag mr-2"></i>BD</a>
                                    </li>
                                ...
                                <div class="dropdownmenu-wrapper custom-scrollbar">
                                    ...
                                    <div class="dropdown-cart-products">
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="{{url('/demo40-product')}}">Ultimate 3D Bluetooth Speaker</a>
                                                </h4>
                                            ...
                                            <figure class="product-image-container">
                                                <a href="{{ url('/demo40-product') }}" class="product-image">
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="{{url('/demo40-product')}}">Brown Women Casual HandBag</a>
                                                </h4>
                                        ...
                                        <div class="product">
                                            <div class="product-details">
                                                <h4 class="product-title">
                                                    <a href="{{url('/demo40-product')}}">Circled Ultimate 3D Speaker</a>
                                                </h4>
                ...
                <div class="container">
                    <nav class="main-nav w-100">
                        <ul class="menu">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li><a href="#">Eggs & Dairy</a></li>
                                                <li><a href="#">Snacks & Candy</a></li>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <ul class="submenu">
                                                <li><a href="#">Baby</a></li>
                                                <li><a href="#">Pets</a></li>
                                                <li><a href="#">Party Supplies & Crafts</a></li>
                                                <li><a href="#">Home, Kitchen & Dine</a></li>
                            ...
                            <li>
                                <a href="{{url('/demo40-product')}}">Products</a>
                                <div class="megamenu megamenu-fixed-width">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <a href="#" class="nolink">PRODUCT PAGES</a>
                                            <ul class="submenu">
                                                <li><a href="{{url('/demo40-product')}}">SIMPLE PRODUCT</a></li>
                                                <li><a href="product-variable.html">VARIABLE PRODUCT</a></li>
                                                <li><a href="{{url('/demo40-product')}}">SALE PRODUCT</a></li>
                                                <li><a href="{{url('/demo40-product')}}">FEATURED & ON SALE</a></li>
                                        ...
                                        <div class="col-lg-4 p-0">
                                            <div class="menu-banner menu-banner-2">
                                                <figure>
                                                    <img src="{{ asset('assets/images/banners/banner-sidebar.jpg') }}"
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <div class="widget">
                                ...
                                <ul class="contact-info">
                                    <li>
                                        <span class="contact-info-label">Address:</span>Dhaka, Bangladesh
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <span class="contact-info-label">Email:</span> <a
                                            href="https://portotheme.com/cdn-cgi/l/email-protection#1b767a72775b7e637a766b777e35787476"><span
                                                class="__cf_email__"
                                                data-cfemail="fe939f9792be9b869f938e929bd09d9193">[email&#160;protected]</span></a>
                                    </li>
                                    <li>
...
<!-- Mirrored from portotheme.com/html/porto_ecommerce/cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 05 Jan 2025 12:53:41 GMT -->
