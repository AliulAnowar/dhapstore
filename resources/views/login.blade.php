                ...
                <nav aria-label="breadcrumb" class="breadcrumb-nav">
                    <div class="container">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ url('/demo40-shop') }}">Shop</a></li>
                            ...
                            <div class="card-body">
                                ...
                                <form action="#" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="login-email">Username or Email Address <span
                                    ...
                                    <button type="submit" class="btn btn-block btn-lg btn-maroon mt-3">LOGIN</button>
                                </form>
                            </div>
                        </div>
                    </div>
